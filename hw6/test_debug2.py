    ...
    for idx1 in range(0,len(string1)):
        ...
        for idx2 in range(0,len(string2)):
            ...
            if string1[idx1] == string2[idx2]:
                ...
                while True:
                    if idx2 + this_match_count>=len(string2) or idx1 + this_match_count>=len(string1):
                        break
                    if string1[idx1 + this_match_count] != string2[idx2 + this_match_count]:
                        break
                    this_match_count += 1
...
def test_match():
    print(match("zero", "zebra"))
    print(match("hell", "hello"))
    print(match("a","b"))
    print(match("a","ab"))
